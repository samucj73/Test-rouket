...
def prever_numeros_quentes(modelo, historico, prob_minima=0.12):
...
numeros_previstos = prever_numeros_quentes(modelo_numeros, historico, prob_minima=0.12)
