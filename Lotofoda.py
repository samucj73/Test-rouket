    ...
    if st.session_state.analise and st.session_state.dados_api and st.session_state.historico_df is not None:
        ...
        with tab3:
            ...
            if "jogos_3622" not in st.session_state or not st.session_state.jogos_3622:
                ...
                if z > 1.96:
                    st.success("""
                    <div style='background:#00ff0020; padding:15px; border-radius:10px; border-left:5px solid #00ff00;'>
                    ...
                    st.warning("""
                    <div style='background:#ffff0020; padding:15px; border-radius:10px; border-left:5px solid #ffff00;'>
                    ...
                    st.info("""
                    <div style='background:#0000ff20; padding:15px; border-radius:10px; border-left:5px solid #0000ff;'>
                    ...
                    if opcoes:
                        ...
                        if concursos_futuros:
                            ...
                            if st.session_state.conferencia_realizada and st.session_state.resultado_conferencia:
                                ...
                                with m4:
                                    # Usar o baseline cache para comparação
                                    baseline = st.session_state.baseline_cache or baseline_aleatorio(n=100000)
                                    vantagem_real = resultado['stats']['media'] - baseline["media"]
