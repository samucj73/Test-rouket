...
with tab13:
    ...
    <div style='background:#1e1e2e; padding:15px; border-radius:10px; margin-bottom:20px; border-left:5px solid #00ffaa;'>
        ...
        <p style='margin:5px 0 0 0;'>Ranking + Diversificação + Atraso + Frequência</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("<br>", unsafe_allow_html=True)
        if st.button("🚀 GERAR IA 7.0", use_container_width=True):
            with st.spinner("Gerando jogos nível profissional..."):
                ...
                if jogos:
                    ...
                    st.error("Erro ao gerar jogos")

    # =============================
    # RESULTADO
    # =============================
    if "jogos_ia" in st.session_state:
