...
class ModeloAltoBaixoZero:
    ...
    def construir_features(self, numeros, modo_treinamento=True):
        ...
        ultimos_100 = classes[-100:] if len(classes) >= 100 else classes
        freq_zero_100 = ultimos_100.count(0) / len(ultimos_100)
        freq_baixo_100 = ultimos_100.count(1) / len(ultimos_100)
        freq_alto_100 = ultimos_100.count(2) / len(ultimos_100)
        ...
        return [
            ...
            freq_zero_100, freq_baixo_100, freq_alto_100,
            lag1, lag2, tendencia,
    ...
    def treinar(self, historico):
        ...
        self.modelo = HistGradientBoostingClassifier(max_iter=300, learning_rate=0.1, random_state=42)
...
if "modelo_abz" not in st.session_state:
    st.session_state.modelo_abz = ModeloAltoBaixoZero(janela=15)
